...
void CWeaponButton::Init(float x, float y, float z, int number, bool flag)
{
	m_ScreenImg = ASPECT;
	...
	m_Poly->Init("asset/button/weaponButton.png", "asset/button/weaponButtonNow.png", m_ImgW, m_ImgH);
...
void CWeaponButton::Uninit()
{
	m_Poly->Uninit();
}

void CWeaponButton::Update()
{
#pragma region 入力
